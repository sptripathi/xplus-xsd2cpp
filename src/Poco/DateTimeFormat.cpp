...
//xplus
const std::string DateTimeFormat::XSD_DATE_FORMAT  = "%Y-%m-%d%z";
const std::string DateTimeFormat::XSD_DAY_FORMAT  = "%d%z";
const std::string DateTimeFormat::XSD_MONTH_FORMAT  = "%m%z";
const std::string DateTimeFormat::XSD_MONTHDAY_FORMAT  = "%m-%d%z";
const std::string DateTimeFormat::XSD_YEARMONTH_FORMAT  = "%Y-%m%z";
const std::string DateTimeFormat::XSD_DURATION_FORMAT  = "P%YY%mM%dDT%HH%MM%sS"; //PnYnMnDTnHnMnS
