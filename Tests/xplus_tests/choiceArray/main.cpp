...
void populateDocument(ns1::Document* xsdDoc)
{
  xsdDoc->element_elem()->set_count_choiceList(2);
  xsdDoc->element_elem()->get_choiceList()->at(0)->set_e1("e1 value");
  xsdDoc->element_elem()->get_choiceList()->at(1)->set_e2("e2 value");
}
